...
import com.just.agentwebX5.sample.sonic.SonicImpl;
import com.just.agentwebX5.sample.sonic.SonicJavaScriptInterface;
...
public class VasSonicFragment extends AgentWebFragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        super.onViewCreated(view, savedInstanceState); // 创建 AgentWebX5 注意的 go("") 传入的 mUrl 应该null 或者""
