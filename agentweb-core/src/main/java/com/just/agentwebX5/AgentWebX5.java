...
public final class AgentWebX5 {
    ...
    public static class PreAgentWeb {
        ...
        PreAgentWeb(AgentWebX5 agentWeb) {
    ...
    public static final class AgentBuilder {
        ...
        public AgentBuilder(@NonNull Activity activity, @NonNull Fragment fragment) {
            mActivity = activity;
            mFragment = fragment;
            mTag = AgentWebX5.FRAGMENT_TAG;
        }

        public AgentBuilder(@NonNull Activity activity) {
            mActivity = activity;
            mTag = AgentWebX5.ACTIVITY_TAG;
        }
        ...
        private PreAgentWeb buildAgentWeb() {
            if (mTag == AgentWebX5.FRAGMENT_TAG && this.mViewGroup == null) {
