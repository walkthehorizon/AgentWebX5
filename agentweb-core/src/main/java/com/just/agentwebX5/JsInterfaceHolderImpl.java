...
public class JsInterfaceHolderImpl extends JsBaseInterfaceHolder {
    ...
    static JsInterfaceHolderImpl getJsInterfaceHolder(WebCreator webCreator, AgentWebX5.SecurityType securityType) {
        return new JsInterfaceHolderImpl(webCreator, securityType);
    }

    JsInterfaceHolderImpl(WebCreator webCreator, AgentWebX5.SecurityType securityType) {
